...
<select name="pageAttributesUsedForFilter[<?php echo $pageAttributeKeyID; ?>][filterSelection]"
    ...
    <option
        value="is_not_exactly" <?php if ($filterSelection == 'is_exactly') print 'selected'; ?>><?php echo t('is not'); ?></option>
    <option
...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php echo(in_array($filterSelection, array($values[0], 'is_empty', 'not_empty', 'matches_all', 'not_matches_all', 'querystring_all', 'not_querystring_all')) ? "display:none;" : ""); ?>">
